                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex justify-center md:justify-start space-x-4">
                            {footerData.social.facebook && (
                                <a href={footerData.social.facebook} target="_blank" rel="noopener noreferrer" className="text-green-200 hover:text-white transition-colors duration-200 group">
                            ...
                            {footerData.social.instagram && (
                                <a href={footerData.social.instagram} target="_blank" rel="noopener noreferrer" className="text-green-200 hover:text-white transition-colors duration-200 group">
                            ...
                            {footerData.social.tiktok && (
                                <a href={footerData.social.tiktok} target="_blank" rel="noopener noreferrer" className="text-green-200 hover:text-white transition-colors duration-200 group">
                            ...
                            {footerData.social.twitter && (
                                <a href={footerData.social.twitter} target="_blank" rel="noopener noreferrer" className="text-green-200 hover:text-white transition-colors duration-200">
